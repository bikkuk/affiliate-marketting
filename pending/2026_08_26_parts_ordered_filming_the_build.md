...
The plan I wrote up last week is now money that has left my account. Every part for the third machine is bought. None of it is here. For the next several days the entire project consists of refreshing tracking pages, which is a genuinely strange phase to be in after a month of arguing with myself about whether to build this at all.
